...
{
    public class BaneDanmarkLaListPnCaseResultListModel
    {
        public int Total { get; set; }
        
        public List<BaneDanmarkLaListPnCaseResultModel> Items { get; set; }
            = new List<BaneDanmarkLaListPnCaseResultModel>();
