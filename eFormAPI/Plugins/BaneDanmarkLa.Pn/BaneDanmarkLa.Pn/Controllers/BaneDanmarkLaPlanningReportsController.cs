...
{
    [Authorize]
    public class BaneDanmarkLaReportsController : Controller
    {        
        private readonly IBaneDanmarkLaReportService _reportService;

        public BaneDanmarkLaReportsController(IBaneDanmarkLaReportService reportService)
        {
            _reportService = reportService;
        }

        [HttpGet]
        [Route("api/bane-danmark-la-pn/reports")]
        ...
        [HttpGet]
        [Route("api/bane-danmark-la-pn/reports/excel")]
